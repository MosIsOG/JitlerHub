...
if AutoFarmTab then
    do
        ...
        -- ...existing code for populating AFLeft and AFRight...
        ...
        local function RefreshMissionDropdownUI()
            for i = #opts, 1, -1 do table.remove(opts, i) end
            for _, m in ipairs(Hub.MissionSystem.AvailableMissions) do table.insert(opts, m) end
            if #opts == 0 then opts = {"No missions found"} end
        ...
        -- ...existing code for AFRight sections...
        -- (Copy the AFRight:CreateSection and AFRight:CreateToggle/Button/Slider code here as needed)
    end
end
