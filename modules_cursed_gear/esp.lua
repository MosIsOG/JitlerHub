...
-- Only basic mob detection for base ESP
...
local function ScanMobs()
    ...
    local function tryTrack(model)
        ...
        -- Only show basic mobs, skip dialog NPCs and bosses in base version
        local npcVal = model:FindFirstChild("NPC")
        if npcVal and npcVal:IsA("StringValue") and npcVal.Value == "Dialog" then return end
